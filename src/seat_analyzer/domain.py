...
class IssueCode(enum.StrEnum):
    ...
    # Workspace（1組織が複数の Team スペースを運用する場合の入力構造）
    WORKSPACE_LAYOUT_MIXED = "WORKSPACE_LAYOUT_MIXED"
    WORKSPACE_CONFIG_MISMATCH = "WORKSPACE_CONFIG_MISMATCH"
    WORKSPACE_PRIMARY_INVALID = "WORKSPACE_PRIMARY_INVALID"
    ...
    GITHUB_CONFIG_UNMATCHED = "GITHUB_CONFIG_UNMATCHED"
...
class ReasonCode(enum.StrEnum):
    ...
    TOTAL_DEMAND_ABOVE_PREMIUM_LINE = "TOTAL_DEMAND_ABOVE_PREMIUM_LINE"
    ...
    CREDIT_SETTING_UNKNOWN = "CREDIT_SETTING_UNKNOWN"
    STANDARD_BILLING_ABOVE_SEAT_GAP = "STANDARD_BILLING_ABOVE_SEAT_GAP"
    CREDIT_CONSUMPTION_RISING = "CREDIT_CONSUMPTION_RISING"
    ...
    IDENTITY_CONFLICT = "IDENTITY_CONFLICT"
    CURRENT_SEAT_UNKNOWN = "CURRENT_SEAT_UNKNOWN"
    CAPACITY_SIGNAL_UNAVAILABLE = "CAPACITY_SIGNAL_UNAVAILABLE"
